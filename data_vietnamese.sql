...
(1, N'Khoa học Thần kinh về Nghiện', N'article', 1, N'/content/markdown/khoa-hoc-nghien.md', N'markdown', N'{"author": "TS. Smith", "readingTime": "12 phút", "difficulty": "trung cấp"}'),
...
(1, N'Dopamine và Con đường Phần thưởng', N'article', 3, N'/content/markdown/dopamine-phan-thuong.md', N'markdown', N'{"author": "TS. Williams", "readingTime": "10 phút", "difficulty": "trung cấp"}'),
...
(1, N'Cập nhật Nghiên cứu Khoa học Nghiện', N'article', 6, N'/content/markdown/nghien-cuu-nghien.md', N'markdown', N'{"author": "Nhóm Nghiên cứu", "readingTime": "8 phút", "difficulty": "nâng cao"}'),

-- Chương trình 2: Não bộ và Nghiện: Góc nhìn Khoa học (5 nội dung)
(2, N'Giải phẫu Não bộ và Nghiện', N'article', 1, N'/content/markdown/giai-phau-nao-nghien.md', N'markdown', N'{"author": "TS. Não bộ", "readingTime": "14 phút", "difficulty": "trung cấp"}'),
...
(2, N'Cơ chế Nhờn thuốc và Phụ thuộc', N'article', 3, N'/content/markdown/co-che-nhon-thuoc.md', N'markdown', N'{"author": "TS. Cơ chế", "readingTime": "11 phút", "difficulty": "nâng cao"}'),
...
(3, N'Cần sa: Sự thật và Ngộ nhận', N'article', 1, N'/content/markdown/su-that-can-sa.md', N'markdown', N'{"author": "Chuyên gia Cần sa", "readingTime": "10 phút", "difficulty": "sơ cấp"}'),
...
(3, N'Cần sa và Sức khỏe Tâm thần', N'article', 3, N'/content/markdown/can-sa-tam-than.md', N'markdown', N'{"author": "Chuyên gia Sức khỏe Tâm thần", "readingTime": "12 phút", "difficulty": "trung cấp"}'),
...
(3, N'Cần sa Y tế và Giải trí', N'article', 5, N'/content/markdown/can-sa-y-te-giai-tri.md', N'markdown', N'{"author": "Chuyên gia Cần sa Y tế", "readingTime": "9 phút", "difficulty": "trung cấp"}'),
...
(3, N'Lái xe và Cần sa: Mối lo An toàn', N'article', 7, N'/content/markdown/can-sa-lai-xe.md', N'markdown', N'{"author": "Chuyên gia An toàn", "readingTime": "7 phút", "difficulty": "sơ cấp"}'),

-- Chương trình 4: Cần sa và Phát triển Thanh thiếu niên (6 nội dung)
(4, N'Phát triển Não tuổi Teen và Cần sa', N'article', 1, N'/content/markdown/nao-tuoi-teen.md', N'markdown', N'{"author": "TS. Thanh thiếu niên", "readingTime": "11 phút", "difficulty": "trung cấp"}'),
...
(4, N'Sử dụng Cần sa sớm: Hậu quả Dài hạn', N'article', 3, N'/content/markdown/can-sa-tuoi-tre.md', N'markdown', N'{"author": "Chuyên gia Phát triển", "readingTime": "10 phút", "difficulty": "trung cấp"}'),
...
(4, N'Lựa chọn Điều trị Cần sa cho Thanh thiếu niên', N'article', 6, N'/content/markdown/dieu-tri-tre-em.md', N'markdown', N'{"author": "Chuyên gia Điều trị Thanh thiếu niên", "readingTime": "13 phút", "difficulty": "nâng cao"}'),

-- Chương trình 5: Cảnh báo Chất Hướng thần Mới (5 nội dung)
(5, N'Chất Hướng thần Mới là gì?', N'article', 1, N'/content/markdown/chat-huong-than-moi.md', N'markdown', N'{"author": "Chuyên gia Cảnh báo Ma túy", "readingTime": "9 phút", "difficulty": "sơ cấp"}'),
...
(5, N'Rủi ro và Tác dụng Thuốc Thiết kế', N'article', 3, N'/content/markdown/rui-ro-thuoc-thiet-ke.md', N'markdown', N'{"author": "Chuyên gia Đánh giá Rủi ro", "readingTime": "11 phút", "difficulty": "trung cấp"}'),
...
(6, N'Chiến lược Phòng ngừa Thuốc Tổng hợp', N'article', 6, N'/content/markdown/phong-ngua-tong-hop.md', N'markdown', N'{"author": "Chuyên gia Phòng ngừa", "readingTime": "9 phút", "difficulty": "sơ cấp"}'),

-- Chương trình 7: Ứng phó Khủng hoảng Fentanyl (7 nội dung)
(7, N'Hiểu về Fentanyl và Nguy cơ', N'article', 1, N'/content/markdown/nguy-co-fentanyl.md', N'markdown', N'{"author": "Chuyên gia Fentanyl", "readingTime": "11 phút", "difficulty": "sơ cấp"}'),
...
(7, N'Fentanyl trong Nguồn cung Ma túy', N'article', 4, N'/content/markdown/fentanyl-nguon-cung.md', N'markdown', N'{"author": "Chuyên gia Nguồn cung Ma túy", "readingTime": "10 phút", "difficulty": "trung cấp"}'),
...
(7, N'Phòng ngừa Fentanyl trong Trường học', N'article', 7, N'/content/markdown/fentanyl-truong-hoc.md', N'markdown', N'{"author": "Chuyên gia An toàn Trường học", "readingTime": "13 phút", "difficulty": "trung cấp"}'),

-- Chương trình 8: Phòng ngừa và Ứng phó Quá liều (5 nội dung)
(8, N'Nhận biết Dấu hiệu Quá liều', N'article', 1, N'/content/markdown/dau-hieu-qua-lieu.md', N'markdown', N'{"author": "Chuyên gia Phòng ngừa Quá liều", "readingTime": "8 phút", "difficulty": "sơ cấp"}'),
...
(8, N'Chăm sóc và Hỗ trợ Sau quá liều', N'article', 4, N'/content/markdown/cham-soc-sau-qua-lieu.md', N'markdown', N'{"author": "Chuyên gia Phục hồi", "readingTime": "12 phút", "difficulty": "trung cấp"}'),
...
(9, N'Giới thiệu về Giảm hại', N'article', 1, N'/content/markdown/gioi-thieu-giam-hai.md', N'markdown', N'{"author": "Chuyên gia Giảm hại", "readingTime": "9 phút", "difficulty": "sơ cấp"}'),
...
(9, N'Chương trình Trao đổi Bơm kim tiêm', N'article', 3, N'/content/markdown/trao-doi-bom-kim.md', N'markdown', N'{"author": "Điều phối viên Trao đổi Bơm kim", "readingTime": "11 phút", "difficulty": "trung cấp"}'),
...
(9, N'Giảm hại dựa trên Bằng chứng', N'article', 6, N'/content/markdown/giam-hai-bang-chung.md', N'markdown', N'{"author": "Nhà nghiên cứu Khoa học", "readingTime": "14 phút", "difficulty": "nâng cao"}'),

-- Chương trình 10: Giáo dục Sử dụng An toàn hơn (5 nội dung)
(10, N'Đánh giá và Giảm thiểu Rủi ro', N'article', 1, N'/content/markdown/danh-gia-rui-ro.md', N'markdown', N'{"author": "Chuyên gia Đánh giá Rủi ro", "readingTime": "10 phút", "difficulty": "trung cấp"}'),
...
(10, N'Phòng ngừa Nhiễm trùng và Bệnh tật', N'article', 4, N'/content/markdown/phong-ngua-nhiem-trung.md', N'markdown', N'{"author": "Chuyên gia Bệnh truyền nhiễm", "readingTime": "12 phút", "difficulty": "trung cấp"}'),
...
(31, N'Lập kế hoạch Hội chợ Phòng ngừa Cộng đồng', N'article', 1, N'/content/markdown/hoi-cho-phong-ngua.md', N'markdown', N'{"author": "Điều phối viên Sự kiện Cộng đồng", "readingTime": "8 phút", "difficulty": "sơ cấp"}'),
(31, N'Hoạt động Thu hút Mọi lứa tuổi', N'article', 2, N'/content/markdown/hoat-dong-hoi-cho.md', N'markdown', N'{"author": "Chuyên gia Thu hút Thanh thiếu niên", "readingTime": "6 phút", "difficulty": "sơ cấp"}'),

-- Chương trình 26: Đi bộ Phục hồi & Biểu tình Hỗ trợ (2 nội dung)
(31, N'Tổ chức Sự kiện Đi bộ Hỗ trợ Phục hồi', N'article', 1, N'/content/markdown/to-chuc-di-bo.md', N'markdown', N'{"author": "Người vận động Phục hồi", "readingTime": "7 phút", "difficulty": "sơ cấp"}'),
(31, N'Xây dựng Mạng lưới Hỗ trợ Cộng đồng', N'article', 2, N'/content/markdown/mang-luoi-ho-tro.md', N'markdown', N'{"author": "Tổ chức Cộng đồng", "readingTime": "9 phút", "difficulty": "sơ cấp"}');
