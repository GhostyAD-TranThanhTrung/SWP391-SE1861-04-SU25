...
const CrafftQuestionModal = ({ 
  ...
  const letterOptions = ['C', 'R', 'A', 'F', 'F', 'T'];
        ...
        <div className="modal-content" style={{ border: 'none', borderRadius: '8px' }}>
          <div className="modal-header" style={{ backgroundColor: '#f8f9fa', borderBottom: '1px solid #dee2e6' }}>
            <h5 className="modal-title" style={{ color: '#495057', fontWeight: '600' }}>
              {mode === 'create' && 'Tạo câu hỏi CRAFFT mới'}
              {mode === 'edit' && 'Chỉnh sửa câu hỏi CRAFFT'}
              {mode === 'view' && 'Xem chi tiết câu hỏi CRAFFT'}
            </h5>
              ...
              <div className="row">
                ...
                <div className="col-md-4 mb-3">
                  ...
                  <select
                    ...
                    disabled={mode === 'view'}
                  >
                    <option value="multi-select">Trắc nghiệm: Chọn nhiều đáp ánán </option>
                ...
                {/* Category */}
                <div className="col-md-4 mb-3">
                  <label className="form-label" style={{ color: '#495057', fontWeight: '500' }}>Danh mục</label>
                  <select
                    name="category"
                    className="form-select"
                    style={{ border: '1px solid #ced4da', borderRadius: '4px' }}
                ...
                {/* Letter */}
                <div className="col-md-4 mb-3">
                  <label className="form-label" style={{ color: '#495057', fontWeight: '500' }}>Chữ cái CRAFFT</label>
                  <select
                    name="letter"
                    className="form-select"
                    style={{ border: '1px solid #ced4da', borderRadius: '4px' }}
...
export default CrafftQuestionModal;
